...
HOST_BINARY tx ibc-transfer transfer transfer $transfer_channel stride1u20df3trc2c2zdhm8qvh2hdjx9ewh00sv6eyy8 4000000inj --from hot --chain-id injective-1 -y --keyring-backend test --node http://rpc-injective-ia.cosmosia.notional.ventures:26657
